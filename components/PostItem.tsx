...
const PostItem: React.FunctionComponent<PostItemProps> = ({
    ...
    return (
        <motion.a
            href={"/posts/" + slug}
            whileTap={{ scale: 0.95 }}
            className="flex flex-col gap-4 text-white w-full h-full shadow-md p-5 rounded-xl border border-transparent hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-sky-600 bg-gray-700"
        >
